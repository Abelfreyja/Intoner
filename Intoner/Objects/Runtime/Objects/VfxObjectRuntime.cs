...
internal sealed unsafe class VfxObjectRuntime : DrawObjectRuntime
{
    ...
    public override void AppendSelectionDraws(SceneSelectionCollector collector)
    {
        ...
        if (TryGetBounds(out var bounds))
        {
            ...
            collector.AddPrimitive(
                ...
                SceneTransformMath.CreateWorldTransform(center, Quaternion.Identity, new Vector3(radius)));
            return;
        }
        ...
        collector.AddPrimitive(
            Snapshot,
            SceneSelectionPrimitiveKind.Sphere,
            SceneTransformMath.CreateWorldTransform(Snapshot.Transform.Position, Quaternion.Identity, new Vector3(fallbackRadius)));
    }
