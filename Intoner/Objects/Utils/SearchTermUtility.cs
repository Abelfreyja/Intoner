...
internal static class SearchTermUtility
{
    ...
    public static string NormalizeSearchText(string searchText)
    {
        ...
        StringBuilder builder = new(searchText.Length);
        AppendNormalizedText(builder, searchText);
    ...
    {
        string normalizedValue = TextUtility.TrimOrEmpty(value);
    ...
    public static string[] BuildStableTerms(HashSet<string> searchTerms)
    {
        string[] stableTerms = [.. searchTerms];
        Array.Sort(stableTerms, StringComparer.OrdinalIgnoreCase);
        return stableTerms;
    }
    ...
    public static string BuildSearchText(IEnumerable<string?> searchTerms)
    {
        ...
        {
            string normalizedSearchTerm = TextUtility.TrimOrEmpty(searchTerm);
    ...
    public static string BuildNormalizedSearchTextFromSet(HashSet<string> searchTerms)
    {
        StringBuilder builder = new(128);
        foreach (string searchTerm in BuildStableTerms(searchTerms))
        {
            AppendNormalizedText(builder, searchTerm);
        }

        return builder.ToString();
    }

    private static void AppendNormalizedText(StringBuilder builder, string value)
    {
